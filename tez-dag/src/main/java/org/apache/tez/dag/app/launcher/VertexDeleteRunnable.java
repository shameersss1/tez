...
class VertexDeleteRunnable implements Runnable {
  ...
  public VertexDeleteRunnable(TezVertexID vertex, JobTokenSecretManager jobTokenSecretManager,
  ...
  public void run() {
    ...
    try {
      ...
      LOG.warn("Could not setup HTTP Connection to the node " + nodeId.getHost() + " for vertex delete. ", e);
    } finally {
      try {
